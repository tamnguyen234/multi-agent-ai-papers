...
class RealTTSEngine:
    ...
    def load_translation_model(self):
        """
        Lazy load VinAI English-to-Vietnamese Translate model weights.
        """
        ...
        logger.info("Initializing VinAI Translate model (vinai/vinai-translate-en2vi-v2)...")
        try:
            ...
            logger.error(f"Failed to load VinAI Translate model: {str(e)}", exc_info=True)
            raise self._translation_error
    ...
    def translate_en_to_vi(self, text: str) -> str:
        """
        Translate English text to Vietnamese using vinai-translate-en2vi-v2.
