...
| Trend Agent | 8102 | `rule_based` (BERTopic) | `rule_based_fallback` |
...
- Port mặc định: `3306`
- 10 bảng, quản lý qua Alembic migration
...
*Tham khảo thêm: [docs/database_schema.md](database_schema.md) | [docs/api_endpoints.md](api_endpoints.md) | [docs/agent_workflow.md](agent_workflow.md)*
