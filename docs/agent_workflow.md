# Workflow các AI Agent (Agent Workflow)
...
*Tham khảo: [docs/system_architecture.md](system_architecture.md) | [docs/api_endpoints.md](api_endpoints.md)*
